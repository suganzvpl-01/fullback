...
@DataProvider	
public Object[][] testCasesForNegativeCredentials() throws IOException{
		Object[][] temp=ExcelUtils.getSheetAsObjectForDataProvider("Utilities/TestData.xlsx", "sheet1");
		return temp;
	}
	
	@Test(groups="dataprovider",dataProvider="testCasesForNegativeCredentials")
	public void negativeCredentialCheckwithPOM(String userName,String passWord) throws IOException {
